...
private AccountTransactionService accountTransactionService;
	...
	public void run(String... args) throws Exception {
		...
		/*Customer customer1=new Customer("pree", "9780808766", "p@p.com", "delhi") ;
		Account account1=new Account(1200.00, "SAVINGS", false);
		Customer customer2=new Customer("karthik", "978080766", "k@k.com", "bangalore") ;
		...
		accountService.withdraw(1l, 289.00,"pree");
		AppUser appUser1=new AppUser("aarthi", "a@a.com", "aarthi", new String[]{"ROLE_ADMIN","ROLE_MGR","ROLE_CLERK"}, true, "357429357");
		AppUser appUser2=new AppUser("presy", "p@r.com", "presy", new String[]{"ROLE_CLERK"}, true, "756429357");
